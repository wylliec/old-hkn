...
class Course(models.Model):
    ...
    class QuerySet(NoDeleteQuerySet):
        ...
        def get_top_courses_by_published_exams(self,n=10):
            courses = list(self.annotate_exam_count(True).order_by("-published_exam_count", "name")[:n])
            courses.sort()
            return courses
...
class Klass(models.Model):
    ...
    needs_survey = models.BooleanField()
    """ whether the course needs course surveys """
