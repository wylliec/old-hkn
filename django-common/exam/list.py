...
def describe_filters(exam_filters):
    ...
    try:
        filters.append("for course \"%s\"" % exam_filters["exam_course"])
    except:
        pass

    try:
        filters.append("with instructor \"%s\"" % exam_filters["exam_instructor"])
    except:
        pass
...
def list_exams(request):
    ...
    d['exams_filter_description'] = describe_filters(exam_filters)
