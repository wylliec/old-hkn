...
from hkn.admin.filterspecs import FilterSpec
from hkn.admin.views.decorators import staff_member_required
...
from hkn.admin.models import LogEntry, ADDITION, CHANGE, DELETION
if not LogEntry._meta.installed:
    raise ImproperlyConfigured, "You'll need to put 'hkn.admin' in your INSTALLED_APPS setting before you can use the admin application."
